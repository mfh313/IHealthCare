//
//  HCHealthManagementAnalysisViewController.m
//  IHealthCare
//
...
@interface HCHealthManagementAnalysisViewController () <tableViewDelegate,UITableViewDataSource,UITableViewDelegate,HCHealthMedicalServiceCellViewDelegate>
{
...
@implementation HCHealthManagementAnalysisViewController
...
- (void)viewDidLoad {
    ...
    [m_tableView addInfiniteScrollingWithActionHandler:^{
        __strong typeof(weakSelf) strongSelf = weakSelf;
        [strongSelf getMedicalServiceMore];
    }];
}
...
-(void)makeCellObjects
{
    ...
    for (int i = 0; i < m_service.count; i++) {
        ...
        medicalService.cellHeight = [self imageHeight] + 38;
