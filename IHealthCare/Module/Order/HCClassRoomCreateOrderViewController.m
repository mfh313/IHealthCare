//
//  HCClassRoomCreateOrderViewController.m
//  IHealthCare
//
...
@interface HCClassRoomCreateOrderViewController () <MMTableViewInfoDelegate,HCOrderAddressSelectViewControllerDelegate>
{
...
@implementation HCClassRoomCreateOrderViewController
...
-(void)initCart
{
    ...
    orderItem.classDetailModel = self.detailModel;
    orderItem.pid = self.detailModel.crid;
    orderItem.count = 1;
