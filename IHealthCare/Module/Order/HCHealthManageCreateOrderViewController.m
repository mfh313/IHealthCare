//
//  HCHealthManageCreateOrderViewController.m
//  IHealthCare
//
...
@implementation HCHealthManageCreateOrderViewController
...
-(void)initCart
{
    ...
    orderItem.manageDetailModel = self.detailModel;
    orderItem.pid = self.detailModel.hcid;
    orderItem.count = 1;
