...
- (void)__setupMaskView
{
    ...
    if ([self needMarkView]) {
        ...
        self.markView.frame = CGRectMake(0, [self.tabDataSource respondsToSelector:@selector(markViewBottom)]?[self.tabDataSource markViewBottom]:-13, [self.tabDataSource markViewWidthForIndex:self.index], 4);
